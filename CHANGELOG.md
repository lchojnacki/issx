...
## [0.6.0] - 2024-05-14
### Added
- Add possibility to configure issue's title template in the config file
...
[Unreleased]: https://github.com/nekeal/issx/compare/0.6.0...master
[0.6.0]: https://github.com/nekeal/issx/compare/0.5.4...0.6.0
